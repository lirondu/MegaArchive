...
var CmsInlineInit = {
	...
	InitializeEditableListElements: function () {
		$('[cms-inline="list"]').each(function () {
			...
			var selectList = $('<select id="cms_inline_elements_list"></select>');
			selectList.attr('id', '');
	...
	InitializeTextareaElements: function () {
		$('[cms-inline="textarea"]').each(function () {
			...
			var textarea = $('<textarea class="cms_inline_textarea">' + content + '</textarea>');
			textarea.attr('id', '');
			textarea.attr('name', 'value');
			textarea.attr('cms-inline', 'textarea');
			textarea.attr('cms-table', table);
			textarea.attr('cms-id', id);
			textarea.attr('cms-field', field);
	...
	InitializeAllEditableElements: function () {
		...
		CmsInlineInit.InitializeTextareaElements();
	}
};
...
$(window).on('contentloaded', function () {
	...
	// 	.each(function () {
	// 		if (!$(this).attr('title')) {
	// 			$(this).attr('title', 'Editable content');
	// 		}
	// 	});
