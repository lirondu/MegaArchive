...
class ContentLoaderArtistAdmin extends ContentLoaderSingleAdmin {
	...
	protected function PrintData() {
		...
		<div class="entry-buttons-container">
			<button class="delete-entry-btn btn btn-sm btn-danger"
				table="artists"
				entry-id="<?= $this->id ?>"
				return-to-page="15">
				Delete
		...
		<form action="">
			<div>
				...
				<?
				$this->PrintCmsInlineElement('first_name', 'text', 
											 'artists', $this->id, 
			...
			<div>
				...
				<?
				$this->PrintCmsInlineElement('last_name', 'text', 
											 'artists', $this->id, 
			...
			<div>
				...
				<?
				$this->PrintCmsInlineElement('edit_sex', 'list', 
											 'artists', $this->id, 
											 'sex', $this->entry['sex'],
											 'Please select;Female;Male', '0;1;2',
											 $this->entry['sex']);
				?>
			</div>
